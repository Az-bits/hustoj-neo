...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de Validación de Lenguaje
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje contienen los mensajes de error predeterminados
    | usados por la clase de validador. Algunas de estas reglas tienen varias versiones,
    | como las reglas de tamaño. Siéntase libre de ajustar estos mensajes aquí.
    |
    */
    ...
    | facilita especificar una línea de lenguaje personalizada para una regla
    ...
    */
    ...
    | posición de atributo por algo más legible, como "Dirección de Correo Electrónico"
    | en lugar de "email". Esto simplemente nos ayuda a hacer nuestro mensaje
    | más expresivo.
    |
    */
